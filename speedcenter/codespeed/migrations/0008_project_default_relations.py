...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.default_environment'
        db.add_column('codespeed_project', 'default_environment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codespeed.Environment'], null=True, blank=True), keep_default=False)

        # Adding field 'Project.default_executable'
        db.add_column('codespeed_project', 'default_executable', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_default', null=True, to=orm['codespeed.Executable']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Project.default_environment'
        db.delete_column('codespeed_project', 'default_environment_id')

        # Deleting field 'Project.default_executable'
        db.delete_column('codespeed_project', 'default_executable_id')
    ...
    models = {
        ...
        'codespeed.executable': {
            'Meta': {'unique_together': "(('project', 'name'),)", 'object_name': 'Executable'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'codespeed.link': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'revision': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'links'", 'to': "orm['codespeed.Revision']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '500'})
        },
        'codespeed.project': {
            'Meta': {'object_name': 'Project'},
            'default_environment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['codespeed.Environment']", 'null': 'True', 'blank': 'True'}),
            'default_executable': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'project_default'", 'null': 'True', 'to': "orm['codespeed.Executable']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
