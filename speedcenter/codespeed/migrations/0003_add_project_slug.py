...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('codespeed_project', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', unique=True, max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Project.slug'
        db.delete_column('codespeed_project', 'slug')
