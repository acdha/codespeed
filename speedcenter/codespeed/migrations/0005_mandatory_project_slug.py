...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('codespeed_project', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', unique=True, max_length=30))


    def backwards(self, orm):
        db.alter_column('codespeed_project', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', unique=True, max_length=30, blank=True))
    ...
    models = {
        ...
        'codespeed.project': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '30', 'blank': 'False'}),
