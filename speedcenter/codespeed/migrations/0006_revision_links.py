...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Link'
        db.create_table('codespeed_link', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('revision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='links', to=orm['codespeed.Revision'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=500)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('codespeed', ['Link'])


    def backwards(self, orm):

        # Deleting model 'Link'
        db.delete_table('codespeed_link')
